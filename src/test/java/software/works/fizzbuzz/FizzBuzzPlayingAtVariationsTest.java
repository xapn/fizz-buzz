...
public class FizzBuzzPlayingAtVariationsTest {
    ...
    public void should_play_at_7_boom() {
        assertThat(sevenBoom().of(3)).isEqualTo(new FizzBuzz()
                .boom()
                .of(3));
    }
    ...
    public void should_play_at_fizz_buzz_woof() {
        assertThat(fizzBuzzWoof().of(3)).isEqualTo(new FizzBuzz()
                .woof()
                .of(3));
    }
    ...
    public void should_play_at_fizz_buzz_pop_whack() {
        assertThat(fizzBuzzPopWhack().of(3)).isEqualTo(new FizzBuzz()
                .popWhack()
                .of(3));
    }
    ...
    public void should_play_at_fizz_buzz_pop_whack_zing_chop() {
        assertThat(fizzBuzzPopWhackZingChop().of(3)).isEqualTo(new FizzBuzz()
                .popWhackZingChop()
                .of(3));
    }
}
